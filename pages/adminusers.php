    ...
    <body>
        ...
        <aside class="nav-sidebar">
            <ul>
                ...
                <li><a href="./products.php">View Manga Products</a></li>
                <li><a href="#">Create Manga Product</a></li>
        ...
        <div class="form-container1" style ="margin-top: -100px;">
                <form action="../php-code/clientupdate.co.php" method="post" class="updateform">
